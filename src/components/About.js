        ...
        <div className=" container mb-4">
            <div className="bg-dark ">
                    ...
                    <div className="col-sm-12 col-lg-8">
                            <h5 className="card-title text-left text-light mb-1 mx-auto">About</h5>
                        </div>
                    </div>
                        <div className="row">
                            <div className="col-sm-12 col-lg-8" >
                                ...
                                <p className="text-light text-justify">If you're looking for a web developer, please contact me! I'm open to both freelance and full time work. I'd love to discuss your project or role's needs!</p>
                            </div>
                            <img src="./dev-pic-min.png" className="col-sm-12 col-lg-4 rounded-circle " alt="Smiling web developer"/>
                        </div>
                    </div>
                </div>
            </div>

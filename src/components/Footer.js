...
export default function Footer() {
    return (
        <div className=" fixed-bottom d-none d-sm-none d-md-block d-lg-block">
                    ...
                    <div className="collapse navbar-collapse text-center" id="navbarNavDropdown">
                        <ul className="navbar-nav mx-auto">
                            ...
                            <li className="nav-item active">
                                <a className="nav-link" onClick={() => window.location = 'mailto:mckilpar000@hotmail.com'}>
